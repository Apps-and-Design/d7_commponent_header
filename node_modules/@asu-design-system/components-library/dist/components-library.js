...
`,Ce="1224px",$e="24px",Pe=L((({disabled:e,small:n,medium:t,large:r,gold:o,maroon:a,dark:s,type:c,...l},f)=>{const d="link"==c?"a":"button";let u=!!l.light&&l.light;return void 0===o&&void 0===s&&void 0===a&&(u=!0),i(d,{...l,class:(0,ie.cx)(ie.css`
...
`,rr=({open:e,maxMobileHeight:n,injectStyles:t,breakpoint:r,handleKeyDown:o,children:a,...s})=>{const c=-1==n?"75vh":n+"px",l="Xl"===r?ce:se;return i("nav",{id:"asu-header-nav",class:(0,ie.cx)("header-nav",e?"open-nav":"",ie.css`
          @media (max-width: ${l}) {
            &.open-nav,
            &:target {
              flex-direction: column;
        ...
        `,t?nr(l):""),...s,children:a})},ir=e=>ie.css`
  .asu-search-form {
    > form {
      display: flex;
      flex-flow: row wrap;
...
`,or=e=>i("div",{class:(0,ie.cx)("asu-search-form",e.class),...e,children:e.children}),ar=e=>ie.css`
  .login-status {
    font-size: 0.75rem;
    display: flex;
    align-items: center;
...
`,sr=e=>i("div",{class:(0,ie.cx)(e.class,"login-status"),children:e.children}),cr=e=>ie.css`
  .navbar-brand {
    display: inline-block;
...
`,lr=L((({brandLink:e,src:n,mobileSrc:t,alt:r,...o},a)=>i("a",{href:e,class:"navbar-brand",ref:a,...o,children:[i("img",{class:"vert",src:n,alt:r}),i("img",{class:"horiz",src:t,alt:r})]}))),fr=e=>ie.css`
  .title {
    line-height: 1;
    font-size: 1rem;
    font-weight: 700;
...
`,dr=L((({children:e,parentOrg:n,baseUrl:t,parentOrgUrl:r,...o},a)=>n?i("div",{class:(0,ie.cx)("title",o.class),ref:a,children:[i("a",{class:"unit-name",href:r,children:n}),i("a",{class:"subunit-name",href:t,children:e})]}):i("a",{class:(0,ie.cx)("title","subunit-name",o.class),href:t,ref:a,children:e}))),ur=e=>ie.css`
  .navlink,
  .navicon,
  .navbutton {
    padding: 0;
...
`,pr=L((({onFocus:e,children:n,...t},r)=>i("li",{class:"navlink",children:i("a",{...t,class:(0,ie.cx)("nav-item",t.class),...e?{onFocus:e}:"",ref:r,children:n})}))),mr=L((({children:e,onFocus:n,type:t,alt:r,...o},a)=>i("li",{class:"navicon",children:i("a",{...o,class:o.class?o.class:"",...n?{onFocus:n}:"",ref:a,children:[i(qt,{type:t,className:"icon-nav-item",alt:r}),i("span",{class:"mobile-only",children:e})]})}))),hr=L((({children:e,...n},t)=>i("li",{class:(0,ie.cx)("navbutton",n.class),children:i(Ee,{...n,ref:t,medium:!0,dark:!0,children:e})}))),gr=e=>ie.css`
  .navbar-toggler {
...
`,br=({mobileOpen:e,...n})=>i("button",{...n,class:(0,ie.cx)(ie.css`
          .fa-circle {
            color: #e8e8e8;
            font-size: 1rem;
            margin-left: -12px;
        ...
        `,"navbar-toggler"),children:i(qt,e?{type:"circle-close"}:{type:"bars",href:"#asu-header-nav"})}),yr=e=>ie.css`
  .navbar-component {
    background-color: #ffffff;
    display: flex;
    width: 100%;
...
`,vr=({children:e,...n})=>i("div",{class:(0,ie.cx)("navbar-component",n.class),children:i("div",{children:e})}),_r=e=>ie.css`
  .navbar-container {
    display: flex;
    width: 100%;
    flex-direction: column;
...
`,wr=e=>i("div",{class:(0,ie.cx)("navbar-container",e.class),children:e.children}),xr=({children:e,breakpoint:n,...t})=>i(r.Fragment,{children:[i("div",{id:"asu-report-accessiblity",children:i("a",{href:"https://www.asu.edu/accessibility/",class:ie.css`
            ${Se}
          ...
          `,yr(n),tr(n),Te,_r(n),cr(n),kr(n),ir(n),fr(n),ar(n),gr(n),ur(n)),children:e})]}),kr=e=>ie.css`
  .universal-nav {
    padding: 0 2rem;
    display: flex;
    justify-content: center;
...
`,Or=L(((e,n)=>i("div",{class:(0,ie.cx)("universal-nav",e.open?"mobile-open":"",e.searchOpen?"search-open":""),ref:n,children:i("div",{children:e.children})}))),zr=({children:e,...n})=>i("div",{class:(0,ie.cx)("nav-grid",n.class),children:e}),Sr=ie.css`
  font-weight: 700;
  text-align: left;
  opacity: 1;
  margin: 1rem 0;
...
`,Cr=({children:e,...n})=>i("h4",{...n,class:(0,ie.cx)(ie.css`
        ...
        `,n.class),children:e}),$r=({children:e,...n})=>i("h3",{...n,class:(0,ie.cx)(ie.css`
          ${Sr}
          font-size: 1.5rem;
          letter-spacing: -0.035em;
        `,n.class),children:e}),Pr=({type:e,...n})=>{switch(e){case"h4":return i(Cr,{class:n.class,children:n.children});case"h3":return i($r,{class:n.class,children:n.children});default:return""}};Pr.propTypes={type:ae().string.isRequired,children:ae().string},Pr.defaultProps={};const Tr=L((({onFocus:e,type:n,children:t,href:r,...o},a)=>{switch(n){case"button":return i(hr,{...o,ref:a,href:r,...e?{onFocus:e}:"",medium:!0,dark:!0,children:t});case"icon":return i(mr,{...o,href:r,...e?{onFocus:e}:"",ref:a,type:o.class,alt:t+" icon",children:t});case"heading":return i(Pr,{type:"h3",children:t});default:return i(pr,{href:r,...e?{onFocus:e}:"",ref:a,...o,children:t})}}));Tr.propTypes={location:ae().array,onFocus:ae().func,type:ae().string,href:ae().string,children:ae().string.isRequired,icon:ae().string},Tr.defaultProps={};const Er=Tr,Mr=L((({text:e,setFocus:n,pIndex:t,isOpen:r,setOpen:o,children:a,mega:s,buttons:c,href:l,...f},d)=>{const u=e=>{o(r?-1:e)};return i("li",{class:r?"dropdown-open":"",children:[i("a",{...f,role:"button","aria-expanded":r,onMouseDown:e=>{e.preventDefault(),u(t)},onKeyDown:e=>{const n=e.keyCode;32!=n&&13!=n||u(t)},onFocus:e=>{n([t,-1,-1])},tabIndex:"0",ref:d,children:[e," ",i(Lt,{sr:e,className:r?"open":""})]}),i(Qt,{open:r,class:s?"mega":"",...c?{buttons:c.map(((e,n)=>i(Ee,{href:e.href,...e.color?{[e.color]:!0}:{},medium:!0,children:e.text})))}:{},children:a})]})}));Mr.propTypes={setFocus:ae().func.isRequired,pIndex:ae().number.isRequired,isOpen:ae().bool,setOpen:ae().func.isRequired,buttons:ae().arrayOf(ae().object),mega:ae().bool,text:ae().string},Mr.defaultProps={isOpen:!1};const jr=Mr,Lr=({navTree:e,width:n,mobileOpen:t,maxMobileHeight:o,buttons:a,injectStyles:s,breakpoint:c})=>{const[l,f]=g([-1,-1,-1]),[d,u]=g(-1),p=e=>{f(e)},m=parseInt("Xl"===c?ce:se,10),h=w((()=>Array.isArray(e)&&0!=e.length?e.map((e=>{const n=(0,r.createRef)();let t=[],{items:i,...o}=e;if(i&&i[0].length>0)for(let e=0;e<i.length;e++)for(let n=0;n<i[e].length;n++)if(t[e]||(t[e]=[]),t[e][n]=Object.assign({},i[e][n]),"heading"!=i[e][n].type){const i=(0,r.createRef)();t[e][n].ref=i}return{ref:n,item:o,menus:t}})):[]),[e]);y((()=>{const e=Ar(l,h);if(e.hasFocus){const[n,t,r]=l;e.isTop?(h[n].ref&&h[n].ref.current!==document.activeElement&&h[n].ref.current.focus(),d!==n&&u(-1)):h[n].menus[t][r].ref&&h[n].menus[t][r].ref.current!==document.activeElement&&h[n].menus[t][r].ref.current.focus()}else-1!==d&&u(-1)}),[l,h]);const b=_(null);y((()=>{const e=e=>{b.current&&!b.current.contains(e.target)&&u(-1)};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}}),[b]);return i(rr,{open:t,maxMobileHeight:o,injectStyles:s,breakpoint:c,children:[i(Zt,{...n>m?{onfocusout:e=>{e.currentTarget.contains(e.relatedTarget)||p([-1,-1,-1])}}:{},onKeyDown:e=>{const n=Ar(l,h);if(n.hasFocus)switch(e.keyCode){case 37:e.preventDefault(),p(Nr(l,n,h));break;case 39:e.preventDefault(),p(Ir(l,n,h));break;case 38:e.preventDefault(),p(Fr(l,n,h));break;case 40:if(n.isTop&&n.hasSubs&&d!=l[0])return void u(l[0]);e.preventDefault(),p(Hr(l,n,h));break;case 27:n.isTop||p([l[0],-1,-1])}},ref:b,children:h.map(((e,n)=>{const t=e.item,r=e.menus;return r&&r.length>0&&r[0].length>0?i(jr,{...t,pIndex:n,setFocus:p,ref:e.ref,isOpen:d==n,setOpen:u,mega:r.length>2,children:r.map(((e,t)=>i(er,{children:e.map(((e,o)=>i(Er,{onFocus:()=>{f([n,t,o]),u(n)},ref:r[t][o].ref,type:e.hasOwnProperty("type")?e.type:void 0,color:e.hasOwnProperty("color")?e.color:void 0,class:e.hasOwnProperty("class")?e.class:void 0,href:e.hasOwnProperty("href")?e.href:void 0,children:e.text})))})))}):i(Er,{onFocus:()=>{p([n,-1,-1])},ref:e.ref,type:t.hasOwnProperty("type")?t.type:void 0,color:t.hasOwnProperty("color")?t.color:void 0,class:t.hasOwnProperty("class")?t.class:"",href:t.hasOwnProperty("href")?t.href:void 0,children:t.text})}))}),a.length>0&&i(Jt,{children:a.map((e=>{let n=e.color?e.color:"maroon";return i(Ee,{href:e.href,[n]:!0,medium:!0,children:e.text})}))})]})};Lr.propTypes={navTree:ae().arrayOf(ae().object),buttons:ae().arrayOf(ae().object),mobileOpen:ae().bool,width:ae().number,height:ae().number,maxMobileHeight:ae().number,injectStyles:ae().bool,breakpoint:ae().oneOf(["Lg","Xl"])},Lr.defaultProps={navTree:[],mobileOpen:!1,width:1920,height:1080,maxMobileHeight:-1,buttons:[],injectStyles:!1};const Ar=(e,n)=>{const[t,r,i]=e;let o=!1,a=!1,s=!1,c=!1,l=!1;return-1==t&&-1==r&&-1==i?{hasFocus:o}:(o=!0,n[t].menus.length>0&&(s=!0),a=-1===r||-1===i,a&&t===n.length-1&&(c=!0),a&&0===t&&(l=!0),{hasFocus:o,isTop:a,hasSubs:s,isLast:c,isFirst:l})},Nr=(e,n,t)=>{const[r,i,o]=e;let a=e;return n.isTop?(a=void 0!==t[r-1]?[r-1,-1,-1]:[0,-1,-1],!1===Rr(a,t)?Nr(a,Ar(a,t),t):a):void 0!==t[r].menus[i-1]?t[r].menus[i-1][0].ref?[r,i-1,0]:[r,i-1,1]:[r,-1,-1]},Ir=(e,n,t)=>{const[r,i,o]=e;let a=e;return n.isTop?(a=void 0!==t[r+1]?[r+1,-1,-1]:[t.length-1,-1,-1],!1===Rr(a,t)?Ir(a,Ar(a,t),t):a):void 0!==t[r].menus[i+1]?t[r].menus[i+1][0].ref?[r,i+1,0]:[r,i+1,1]:[r,-1,-1]},Fr=(e,n,t)=>{const[r,i,o]=e;let a=[],s=e;return n.hasSubs&&(a=t[r].menus),s=n.isTop?Nr(e,n,t):void 0!==a[i][o-1]?[r,i,o-1]:[r,-1,-1],!1===Rr(s,t)?Fr(s,Ar(s,t),t):s},Hr=(e,n,t)=>{const[r,i,o]=e;let a=[],s=e;return n.hasSubs&&(a=t[r].menus),s=n.isTop&&n.hasSubs?[r,0,0]:n.isTop?Ir(e,n,t):void 0!==a[i][o+1]?[r,i,o+1]:Ir(e,n,t),!1===Rr(s,t)?Hr(s,Ar(s,t),t):s},Rr=(e,n)=>{const t=Ar(e,n);if(!t.hasFocus)return!1;if(t.isTop){if(n[e[0]].ref)return!0}else if(n[e[0]].menus[e[1]][e[2]].ref)return!0;return!1},Ur=({type:e,open:n,inputRef:t,mobile:r,...o})=>{switch(e){case"d7":return i("div",{children:"Drupal 7"});default:return i("form",{action:"https://search.asu.edu/search",method:"get",role:"search",class:n?"show-search-input":"",...o,children:[i("button",{type:"submit"}),i("input",{name:"q",type:"search",...t?{ref:t}:{},"aria-labelledby":"asu-search-label",...r?{placeHolder:"Search ASU"}:{},required:!0}),i("label",{class:"univeral-search",id:"asu-search-label",onmousedown:()=>event.preventDefault(),children:"Search ASU"})]})}};Ur.propTypes={type:ae().string,open:ae().bool,inputRef:ae().oneOfType([ae().func,ae().shape({current:ae().instanceOf(ae().element)})]),mobile:ae().bool},Ur.defaultProps={};const Dr=({type:e,open:n,setOpen:t,mobile:r})=>{const o=_(null);y((()=>{o.current.value&&t(!0)}),[]);const a=x((e=>{o.current.value||e.currentTarget.contains(e.relatedTarget)||t(!1)}),[n]),s=x((e=>{t(!0),o.current.focus()}),[n]),c=x((()=>{t(!0)}),[n]);return i(or,{onfocusin:c,onfocusout:a,onClick:s,children:i(Ur,{open:n,type:e,inputRef:o,mobile:r})})};Dr.propTypes={type:ae().string,open:ae().bool,setOpen:ae().func,mobile:ae().bool},Dr.defaultProps={open:!1};const Wr=({loggedIn:e,loginLink:n,logoutLink:t,userName:o,...a})=>i(sr,{class:a.class,children:e?i(r.Fragment,{children:[o?i("span",{class:"name",children:o}):"",i("a",{class:"signout",href:t,children:"Sign Out"})]}):i("a",{href:n,children:"Sign in"})});Wr.propTypes={class:ae().string,loggedIn:ae().bool.isRequired,loginLink:ae().string,logoutLink:ae().string,userName:ae().string},Wr.defaultProps={logoutLink:"https://webapp4.asu.edu/myasu/Signout",loginLink:"https://weblogin.asu.edu/cgi-bin/login",loggedIn:!1};const qr=({children:e,mobileOpen:n,logo:t,...r})=>i(vr,{mobileOpen:n,children:[t,i(br,{...r,mobileOpen:n}),i(wr,{children:e})]});qr.propTypes={mobileOpen:ae().bool,logo:ae().node,children:ae().node},qr.defaultProps={mobileOpen:!1};const Vr=L(((e,n)=>i(lr,{ref:n,...e})));Vr.propTypes={alt:ae().string,src:ae().string,mobileSrc:ae().string,brandLink:ae().string},Vr.defaultProps={alt:"Arizona State University",src:"https://www.asu.edu/asuthemes/5.0/assets/arizona-state-university-logo-vertical.png",mobileSrc:"https://www.asu.edu/asuthemes/5.0/assets/arizona-state-university-logo.png",brandLink:"https://asu.edu"};const Yr=(e,n,t)=>(0,r.hydrate)((0,r.h)(e,n),t),Br=(e,n,t)=>(0,r.render)((0,r.h)(e,n),t),Xr=()=>{let e={userName:"",loggedIn:!1};const n=document.cookie.split(";");for(let t=0;t<n.length;t++)if(n[t].indexOf("SSONAME")>0){if(""==n[t].substring(9))break;e.userName=n[t].substring(9),e.loggedIn=!0;break}return e},Gr=e=>{let n;const t=window.location.toString();return n=decodeURI(e),n=n.replace("/login","/login?callapp="+t),n},Kr=e=>{const n=e||window.location.hostname,t=document.cookie.split("; ").find((e=>e.startsWith("title_loaded")));return!document.referrer.includes(n)&&!t&&(document.cookie="title_loaded=true;max-age=600",!0)},Zr=(e,n="headerContainer",t=!1)=>{const{loggedIn:r,userName:i,loginLink:o,...a}=e,s=o||Gr(Wr.defaultProps.loginLink),c={...r&&i?{loggedIn:r,userName:i}:Xr(),...a,loginLink:s};t?Yr(ei,c,document.getElementById(n)):Br(ei,c,document.getElementById(n))},Jr=L((({children:e,baseUrl:n,animate:t,...r},o)=>{const[a,s]=g(!1);return y((()=>{if(!0!==t&&!1!==t){if(!1!==t){let e="/"==n?window.location.hostname:n;e.includes(window.location.hostname)||0!==e.indexOf("/")||(e=window.location.hostname+e),Kr(e)&&s(!0)}}else s(t)}),[a,t,n]),i(dr,{ref:o,...r,class:a?"active":"",baseUrl:n,children:e})}));function Qr(){const e="undefined"!=typeof window,{innerWidth:n,innerHeight:t}=e?window:{innerWidth:1920,innerHeight:1080};return{width:n,height:t}}Jr.propTypes={baseUrl:ae().string,parentOrg:ae().string,parentOrgUrl:ae().string,animate:ae().bool},Jr.defaultProps={baseUrl:"/",parentOrgUrl:"/"};const ei=({navTree:e,title:n,baseUrl:t,parentOrg:o,parentOrgUrl:a,logo:s,loggedIn:c,userName:l,loginLink:f,logoutLink:d,buttons:u,breakpoint:p,animateTitle:m,...h})=>{const[b,v]=g(!1),[w,x]=g(!1),[k,O]=g(-1),z="Xl"===p?ce:se,S=parseInt(z,10),{height:C,width:$}=function(){const[e,n]=g(Qr());return y((()=>{function e(){n(Qr())}return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)}),[]),e}(),[P,T]=g(0),E=()=>{const e=window.pageYOffset;T(e)};y((()=>(window.addEventListener("scroll",E,{passive:!0}),()=>{window.removeEventListener("scroll",E)})),[]);const M=_(null),j=_(null),L=_(null);return y((()=>{if($<S&&b){const e=M.current.clientHeight,n=j.current.clientHeight,t=L.current.clientHeight,r=parseInt($e,10);O(C-e-(n+t+2*r))}}),[C,$,b,S]),i(xr,{breakpoint:z,class:P>0||b&&$<S?"scrolled":"",children:[i(Or,{open:b,ref:M,searchOpen:w,children:[i(zr,{children:[i("a",{href:"https://www.asu.edu/",children:"ASU home"}),i("a",{href:"https://my.asu.edu/",children:"My ASU"}),i("a",{href:"https://www.asu.edu/colleges/",children:"Colleges and schools"}),i(Wr,{loggedIn:c,loginLink:f,logoutLink:d,userName:l})]}),i(Dr,{open:w,setOpen:x,mobile:$<S})]}),i(qr,{onClick:e=>{e.preventDefault(),v((e=>!e))},mobileOpen:b,logo:i(Vr,{...s,ref:j}),children:h.dangerouslyGenerateStub?i("div",{id:"asu-generated-stub"}):i(r.Fragment,{children:[i(Jr,{parentOrg:o,parentOrgUrl:a,baseUrl:t,animate:m,ref:L,children:n}),i(Lr,{navTree:e,mobileOpen:b,height:C,width:$,buttons:u,maxMobileHeight:k,breakpoint:p})]})})]})};ei.propTypes={navTree:ae().arrayOf(ae().object),logo:ae().shape(Vr.propTypes),title:Jr.propTypes.title,parentOrg:Jr.propTypes.parentOrg,parentOrgUrl:Jr.propTypes.parentOrgUrl,baseUrl:Jr.propTypes.baseUrl,loggedIn:Wr.propTypes.loggedIn,userName:Wr.propTypes.userName,loginLink:Wr.propTypes.loginLink,logoutLink:Wr.propTypes.logoutLink,buttons:ae().arrayOf(ae().object),breakpoint:ae().oneOf(["Lg","Xl"]),animateTitle:ae().bool},ei.defaultProps={navTree:[],dangerouslyGenerateStub:!1,title:"",buttons:[],breakpoint:"Lg"};const ni=e=>i("div",{class:(0,ie.cx)(e.class,ie.css`
          padding: 2rem;
          margin-bottom: 2rem;
          border-radius: 0.3rem;
          border: 1px solid #dee2e6;
        `),children:e.children}),ti=e=>i(ni,{class:e.class,children:e.children});ti.propTypes={class:ae().string},ti.defaultProps={}},572:e=>{e.exports=n},555:n=>{n.exports=e},24:e=>{e.exports=t}},i={};function o(e){if(i[e])return i[e].exports;var n=i[e]={exports:{}};return r[e](n,n.exports,o),n.exports}return o.n=e=>{var n=e&&e.__esModule?()=>e.default:()=>e;return o.d(n,{a:n}),n},o.d=(e,n)=>{for(var t in n)o.o(n,t)&&!o.o(e,t)&&Object.defineProperty(e,t,{enumerable:!0,get:n[t]})},o.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(e){if("object"==typeof window)return window}}(),o.o=(e,n)=>Object.prototype.hasOwnProperty.call(e,n),o.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},o(822)})()}));